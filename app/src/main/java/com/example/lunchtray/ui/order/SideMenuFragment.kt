...
class SideMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // DONE: initialize the SideMenuFragment variables
     ...
     */
    fun goToNextScreen() {
        // DONE: Navigate to the AccompanimentMenuFragment
     ...
     */
    fun cancelOrder() {
        // DONE: Reset order in view model
        sharedViewModel.resetOrder()
        // DONE: Navigate back to the [StartFragment] to start over
